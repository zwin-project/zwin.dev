...
![2d ランチャーでこのページを開くGIF](image1.png "image_tooltip")
...
.
```
そしてZenをログアウトして再起動すれば、ターミナルのアイコンが現れます。
...
これでスクロールで惑星を回すことができる、地球儀に近いアプリケーションができました！
...
UNIX哲学の[Do one thing, and do it well.](https://en.wikipedia.org/wiki/Unix_philosophy#Do_One_Thing_and_Do_It_Well)を体現するアプリケーションを作って、オープンなVRやAR空間を築きましょう。
